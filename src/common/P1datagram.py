...
class P1datagram:    
    def __init__(self) -> None:
        ...
        self.actual_electricity_power_received = 0               # 1-0:2.7.0(1.234*kW)  received from customer
        self.actual_electricity_power_delivered = 0              # 1-0:1.7.0(0.215*kW)  devlived to customer
